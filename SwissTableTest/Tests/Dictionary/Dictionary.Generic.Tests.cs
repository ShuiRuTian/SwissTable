...
namespace System.Collections.Tests
{
    ...
    public abstract class Dictionary_Generic_Tests<TKey, TValue> : IDictionary_Generic_Tests<TKey, TValue>
    {
        ...
        protected override IDictionary<TKey, TValue> GenericIDictionaryFactory() => new MyDictionary<TKey, TValue>();

        protected override IDictionary<TKey, TValue> GenericIDictionaryFactory(IEqualityComparer<TKey> comparer) => new MyDictionary<TKey, TValue>(comparer);
        ...
        public void Dictionary_Generic_Constructor_IDictionary(int count)
        {
            ...
            IDictionary<TKey, TValue> copied = new MyDictionary<TKey, TValue>(source);
        ...
        public void Dictionary_Generic_Constructor_IDictionary_IEqualityComparer(int count)
        {
            ...
            IDictionary<TKey, TValue> source = GenericIDictionaryFactory(count);
            MyDictionary<TKey, TValue> copied = new MyDictionary<TKey, TValue>(source, comparer);
            Assert.Equal(source, copied);
        ...
        {
            IDictionary<TKey, TValue> dictionary = new MyDictionary<TKey, TValue>(count);
        ...
        {
            IEqualityComparer<TKey> comparer = GetKeyIEqualityComparer();
            MyDictionary<TKey, TValue> dictionary = new MyDictionary<TKey, TValue>(count, comparer);
            Assert.Equal(0, dictionary.Count);
        ...
        {
            MyDictionary<TKey, TValue> dictionary = (MyDictionary<TKey, TValue>)GenericIDictionaryFactory(count);
            int seed = 4315;
        ...
        {
            MyDictionary<TKey,TValue> dict = (MyDictionary<TKey, TValue>)GenericIDictionaryFactory(3);
        ...
        {
            var dictionary = (MyDictionary<TKey, TValue>)(GenericIDictionaryFactory(count));
        ...
        {
            var dictionary = new MyDictionary<TKey, TValue>();
        ...
        public void EnsureCapacity_Generic_RequestedCapacitySmallerThanCurrent_CapacityUnchanged(int currentCapacity)
        {
            ...
            {
                dictionary = new MyDictionary<TKey, TValue>(currentCapacity);
        ...
        {
            var dictionary = new MyDictionary<TKey, TValue>(capacity);
            Assert.Equal(capacity, dictionary.EnsureCapacity(capacity));

            dictionary = (MyDictionary<TKey, TValue>)GenericIDictionaryFactory(capacity);
            Assert.Equal(capacity, dictionary.EnsureCapacity(capacity));
        }
        ...
        public void EnsureCapacity_Generic_EnsureCapacityCalledTwice_ReturnsSameValue(int count)
        {
            ...
            dictionary = (MyDictionary<TKey, TValue>)GenericIDictionaryFactory(count);
        ...
        public void TrimExcess_Generic_CapacitySmallerThanCount_Throws(int suggestedCapacity)
        {
            ...
            dictionary = new MyDictionary<TKey, TValue>(suggestedCapacity);
            dictionary.Add(GetNewKey(dictionary), CreateTValue(0));
            AssertExtensions.Throws<ArgumentOutOfRangeException>("capacity", () => dictionary.TrimExcess(0));
        }
        ...
        {
            var dictionary = new MyDictionary<TKey, TValue>(20);
        ...
        public void TrimExcess_Generic_TrimToLargerThanExistingCapacity_DoesNothing(int suggestedCapacity)
        {
            ...
            dictionary = new MyDictionary<TKey, TValue>(suggestedCapacity/2);
        ...
        {
            var dictionary = new MyDictionary<int, int>(20);
        ...
        public void TrimExcess_WithArguments_OnDictionaryWithManyElementsRemoved_TrimsToAtLeastRequested(int finalCount)
        {
            ...
            var dictionary = new MyDictionary<int, int>(initialCount);
        ...
        {
            var dictionary = new MyDictionary<string, int>(7);
            for (int i = 0; i < 4; i++)
            {
        ...
        public void Dictionary_Comparer_NonRandomizedStringComparers()
        {
            ...
            void RunTest(IEqualityComparer<string> comparer)
            {
                ...
                MyDictionary<string, object> dict = new MyDictionary<string, object>(comparer);
