    ...
    public class InternalHashCodeTests
    {
        ...
        public static void ComparerImplementations_Dictionary_WithWellKnownStringComparers()
        {
            ...
            RunCollectionTestCommon(
                () => new MyDictionary<string, object>(StringComparer.Ordinal),
                (dictionary, key) => MyDictionary<string, object>.CollectionsMarshalHelper.GetValueRefOrAddDefault(dictionary, key, out _) = null,
            ...
            {
                RunCollectionTestCommon(
                    () => new MyDictionary<string, object>(equalityComparer),
