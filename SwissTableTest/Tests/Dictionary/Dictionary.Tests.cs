...
namespace System.Collections.Tests
{
    public partial class Dictionary_IDictionary_NonGeneric_Tests : IDictionary_NonGeneric_Tests
    {
        ...
        {
            return new MyDictionary<string, string>();
        }
        ...
        {
            IDictionary dictionary = new MyDictionary<string, int>();
        ...
        public void IDictionary_NonGeneric_ItemSet_KeyOfWrongType()
        {
            if (!IsReadOnly)
            {
                IDictionary dictionary = new MyDictionary<string, string>();
    ...
    public class Dictionary_Tests
    {
        ...
        {
            AssertExtensions.Throws<ArgumentNullException>("dictionary", () => new MyDictionary<int, int>((IDictionary<int, int>)null));
            AssertExtensions.Throws<ArgumentNullException>("dictionary", () => new MyDictionary<int, int>((IDictionary<int, int>)null, null));
            AssertExtensions.Throws<ArgumentNullException>("dictionary", () => new MyDictionary<int, int>((IDictionary<int, int>)null, EqualityComparer<int>.Default));

            AssertExtensions.Throws<ArgumentOutOfRangeException>("capacity", () => new MyDictionary<int, int>(new NegativeCountDictionary<int, int>()));
            AssertExtensions.Throws<ArgumentOutOfRangeException>("capacity", () => new MyDictionary<int, int>(new NegativeCountDictionary<int, int>(), null));
            AssertExtensions.Throws<ArgumentOutOfRangeException>("capacity", () => new MyDictionary<int, int>(new NegativeCountDictionary<int, int>(), EqualityComparer<int>.Default));
        }
        ...
        {
            MyDictionary<string, string> collection = (MyDictionary<string, string>)CreateDictionary(count, k => k.ToString());
        ...
        private static void TestCopyConstructor<T>(int size, Func<int, T> keyValueSelector, Func<IDictionary<T, T>, IDictionary<T, T>> dictionarySelector)
        {
            ...
            Assert.Equal(expected, new MyDictionary<T, T>(input));
        }
        ...
        {
            MyDictionary<string, int> source = new MyDictionary<string, int> { { "a", 1 }, { "A", 1 } };
            AssertExtensions.Throws<ArgumentException>(null, () => new MyDictionary<string, int>(source, StringComparer.OrdinalIgnoreCase));
        }
        ...
        public void DictionaryOrdinalIgnoreCaseCyrillicKeys()
        {
            ...
            var dictionary = new MyDictionary<string, int>(StringComparer.OrdinalIgnoreCase);
        ...
        private static void TestCopyConstructor<T>(int size, Func<int, T> keyValueSelector, Func<IDictionary<T, T>, IDictionary<T, T>> dictionarySelector, IEqualityComparer<T> comparer)
        {
            ...
            Assert.Equal(expected, new MyDictionary<T, T>(input, comparer));
        }
        ...
        {
            MyDictionary<T, T> dict = new MyDictionary<T, T>(Enumerable.Range(0, size + 1).ToDictionary(keyValueSelector, keyValueSelector, comparer));
        ...
        private static void TestComparerSerialization<T>(IEqualityComparer<T> equalityComparer, string internalTypeName = null)
        {
            ...
            var dict = new MyDictionary<T, T>(equalityComparer);

            Assert.Same(equalityComparer, dict.Comparer);

            bf.Serialize(s, dict);
            s.Position = 0;
            dict = (MyDictionary<T, T>)bf.Deserialize(s);
        ...
        private sealed class DictionarySubclass<TKey, TValue> : MyDictionary<TKey, TValue>
        {
